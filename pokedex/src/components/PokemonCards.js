...
import { PokemonDetalhePage } from '../Router/coordinator'
...
const PokemonCard = (props) => {
    const { pokemon, pokemonName, addToPokedex, removePokedex} = props
        ...
        <>
            ...
            {(location.pathname === '/' || location.pathname === '/pokedex') &&
                ...
                >
                    ...
                    >
                        <Text onClick={() => {
                            PokemonDetalhePage(navigate, pokemonCards.name)
                        }}
